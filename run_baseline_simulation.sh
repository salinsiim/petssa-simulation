...
python $TS_SIMULATION/output/aggregate_output.py --input "${TS_SIMULATION}/output/map/baseline/result.csv" --output "${TS_SIMULATION}/output/map/baseline/aggregated-result.csv"
